 ...
 * @internal
 *
 * @coversDefaultClass \Zeggriim\RiotApiDataDragon\DataDragon\Endpoint\ChampionApi
 */
final class ChampionApiTest extends KernelTestCase
{
    ...
    public function testGetChampionsAsCollection(): void
    {
        $data = [
            'type' => 'champion',
            'format' => 'standAloneComplex',
        ...
        $championApi = $this->getChampionApi($data);
        $championCollection = $championApi->getChampionsAsCollection('14.6.1');
        ...
        self::assertSame($data['format'], $championCollection->format);

        self::assertNotEmpty($championCollection->getByRole('Marksman'));
        self::assertNotEmpty($championCollection->getChampion('Akshan'));

        // Champion 1
        $championOne = $championCollection->getChampions()['Aatrox'];
        self::assertInstanceOf(Champion::class, $championOne);
        $this->assertChampionObjet($data['data']['Aatrox'], $championOne);
    }
    ...
    public function testGetChampionObjet(): void
    {
        $data = [
            'type' => 'champion',
            'format' => 'standAloneComplex',
        ...
        $championApi = $this->getChampionApi($data);
        $champion = $championApi->getChampionAsObject('aatrox', '14.8.1');

        // Champion
        self::assertInstanceOf(Champion::class, $champion);
        $this->assertChampionObjet($data['data']['Aatrox'], $champion, true);
    }
