 ...
 * @internal
 *
 * @coversDefaultClass \Zeggriim\RiotApiDataDragon\DataDragon\Endpoint\ProfileIconApi
 */
final class ProfileIconApiTest extends KernelTestCase
{
    ...
    public function testGetProfileIconAsCollection(): void
    {
        $data = [
            'type' => 'profileicon',
            'version' => '14.8.1',
        ...
        $profileIconApi = $this->getProfileIconApi($data);
        $profileIcons = $profileIconApi->getProfileIconAsCollection('14.8.1');

        self::assertInstanceOf(ProfileIconCollection::class, $profileIcons);
        self::assertSame($data['type'], $profileIcons->type);
        self::assertSame($data['version'], $profileIcons->version);
