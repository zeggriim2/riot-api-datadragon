 ...
 * @internal
 *
 * @coversDefaultClass \Zeggriim\RiotApiDataDragon\DataDragon\Endpoint\SummonerApi
 */
final class SummonerApiTest extends KernelTestCase
{
    ...
    public function testSummonerAsCollection(): void
    {
        $data = [
            'type' => 'summoner',
            'version' => '14.8.1',
        ...
        // Item 1
        $summoner = $summoners->summoners['SummonerHeal'];
        $dataSummoner = $data['data']['SummonerHeal'];
        ...
        self::assertSame($dataSummoner['cost'][0], $summoner->cost[0]);
        self::assertSame($dataSummoner['costBurn'], $summoner->costBurn);
        self::assertSame($dataSummoner['effect'], $summoner->effect);
        self::assertSame($dataSummoner['effectBurn'], $summoner->effectBurn);
    }
}
